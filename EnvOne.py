...
class EnvOne(gym.Env):
    def __init__(self, size: int = 20, target_size: int = 3, alphabet = {
    ...
    prop_empty = 0.0, alphabet_real = False):
        super(EnvOne, self).__init__()
        ...
        self._grid = None  # The 1D grid of characters
        ...
        self.observation_space = spaces.Dict({
            ...
            "current_character": spaces.Discrete(28),  # 0 is error, 1-26 is a-z, 27 is _
    ...
    def _generate_grid(self):
        '''
        Generating a grid based on the probabilities, size, target_string, and target_size.
        ...
        # Getting characters and probablities
        ...
        if self.target_size in COMMON_WORDS_BY_LENGTH:
            ...
            target_string = ''.join(grid[target_start:target_start + self.target_size])
        ...
        # Place the target string at a random position in the grid using seeded random
        target_start = self.np_random.integers(0, self.size - self.target_size + 1)
    ...
    def _char_to_num(self, char):
        '''
        This is solely for the observation space, printing out 0 if some error has occured,
    ...
    def _get_obs(self):
        ...
        '''
        current_char = self._grid[self._agent_location] if 0 <= self._agent_location < self.size else '_'
    ...
    def reset(self, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        self._grid, self._target_string, self._target_start_pos, self._target_end_pos = self._generate_grid()
    ...
    def step(self, action):
        ...
        if action == 0:  # Move left
            ...
            if self._guess_start == self._target_start_pos and self._guess_end == self._target_end_pos:
    ...
    def render(self, mode='human'):
        ...
        if mode == 'human':
            ...
            print(f"Target: '{self._target_string}' at positions {self._target_start_pos}-{self._target_end_pos}")
